...
export const SessionPanel = ({
	...
	return (
		<Card className="widget-panel z-10 p-0 md:p-0 gap-0 md:gap-0 shadow-long overflow-hidden animate-widget-panel-in max-w-sm mx-auto mb-4">
			{error && (
			...
			<CardContent className="relative flex flex-col justify-center flex-1 w-full aspect-square max-w-sm py-0 md:py-0 animate-fade-in overflow-hidden">
				{showWaveform && (
					<CircularWaveform
